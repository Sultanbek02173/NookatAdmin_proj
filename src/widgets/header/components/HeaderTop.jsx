        ...
        <div className="headerTop">
            ...
            <div className="headerTop_right">
                ...
                <div className="socials">
                    <a href="#"><div><img src={instagramIcon} alt="Instagram" /></div></a>
                    <a href="#"><div><img src={telegramIcon} alt="Telegram" /></div></a>
                    <a href="#"><div><img src={whatsappIcon} alt="WhatsApp" /></div></a>
                    <a href="#"><div><img src={youtubeIcon} alt="YouTube" /></div></a>
                </div>
            </div>
        </div>
    );
